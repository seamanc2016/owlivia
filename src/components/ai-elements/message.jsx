...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-assistant]:rounded-lg group-[.is-assistant]:rounded-bl-none group-[.is-assistant]:bg-secondary group-[.is-assistant]:px-4 group-[.is-assistant]:py-3 group-[.is-assistant]:text-foreground",
      className
    )}
    {...props}>
    {children}
