  ...
  (
    ...
    return (
      ...
      >
        ...
        <div className="container relative z-10 mx-auto flex h-full max-w-screen-2xl items-center justify-center px-4 md:px-6 lg:justify-start lg:px-24">
          <div className=" flex w-full max-w-md flex-col items-center text-center sm:max-w-lg md:max-w-2xl lg:max-w-xl lg:items-start lg:text-left">
            ...
            <img
              src={mobileImage}
              alt="Owlivia"
              className="mb-6 block w-64 sm:w-80 md:w-md lg:hidden"
            />
