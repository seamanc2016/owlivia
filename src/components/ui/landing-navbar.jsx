                    ...
                    {navigationLinks.map((link, index) => (
                      <NavigationMenuItem key={index}>
                        <a
                          href={link.href}
                          className={cn(
                            "group inline-flex h-9 w-max cursor-pointer items-center justify-center rounded-md px-4 py-2 text-sm font-medium no-underline transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none",
                            link.active
                              ? "bg-accent text-accent-foreground"
